...
# (Accessible on github.com/Circiter/maze-in-sed).
# Original by xsot (github.com/xsot)

# Simple and relatively fast flood fill solver with
# compromise between speed and quality of a solution.

:input $!{N; binput} # Work on the entire file, not on line-by-line basis.

s/^.*$/&\n/ # This line can be replace by G.
